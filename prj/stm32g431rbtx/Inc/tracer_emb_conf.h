...
#include "stm32g4xx_ll_lpuart.h"/* Private typedef -----------------------------------------------------------*/
...
#define TRACER_EMB_TX_DMA_IRQ                        DMA1_Channel4_IRQn
#define TRACER_EMB_TX_DMA_IRQHANDLER                 DMA1_Channel4_IRQHandler
